<script>
  import PlannerBody from "./PlannerBody.svelte";
  export let plannerData;

  let viewPlanner = true;
  ...
  <div class="text-center">
    <div class="mx-2">
      <button
        ...
        class="flex flex-row items-center justify-center rounded-lg border-2 border-slate-700 bg-slate-100 px-4 py-1 text-xs font-bold text-black drop-shadow-lg hover:bg-slate-600 hover:text-white"
      >
        <span class="mr-2">
          {#if !viewPlanner}
            <svg
